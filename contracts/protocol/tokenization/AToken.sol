  ...
  IAToken
{
  ...
  function mintToTreasury(uint256 amount, uint256 index) external override onlyLendingPool {
    ...
    address secondTreasury = _secondTreasury;
    ...
    if(secondTreasury == address(0)) {
      ...
      uint256 amountSecondTreasury = _amount.sub(amountTreasury);

      _mint(treasury, amountTreasury);
      emit Transfer(address(0), treasury, amountTreasury);
  ...
  /**
   * @dev Returns the address of the Protocol treasury, receiving the fees on this aToken
   **/
  function PROTOCOL_TREASURY_ADDRESS() public view returns (address) {
    return _secondTreasury;
  }
  ...
  function _setParams(
    ...
    _pool = pool;
    _treasury = treasury;
    _secondTreasury = secondTreasury;
